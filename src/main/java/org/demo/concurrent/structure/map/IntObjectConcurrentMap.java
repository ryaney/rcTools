...
public class IntObjectConcurrentMap<V> implements IntObjectMap<V> {
    ...
    public IntObjectConcurrentMap() {
        this(DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR);
    }

    public IntObjectConcurrentMap(int initialCapacity) {
        this(initialCapacity, DEFAULT_LOAD_FACTOR);
    }

    public IntObjectConcurrentMap(int initialCapacity, float loadFactor) {
    ...
    public void putAll(Map<? extends Integer, ? extends V> sourceMap) {
        if (sourceMap instanceof IntObjectConcurrentMap) {
            // Optimization - iterate through the arrays.
            @SuppressWarnings("unchecked")
            IntObjectConcurrentMap<V> source = (IntObjectConcurrentMap<V>) sourceMap;
    ...
    private final class EntrySet extends AbstractSet<Entry<Integer, V>> {
        ...
        @Override
        public int size() {
            return IntObjectConcurrentMap.this.size();
        }
    }
    ...
    private final class KeySet extends AbstractSet<Integer> {
        ...
        public boolean contains(Object o) {
            return IntObjectConcurrentMap.this.containsKey(o);
        }

        @Override
        public boolean remove(Object o) {
            return IntObjectConcurrentMap.this.remove(o) != null;
        }
        ...
        @Override
        public void clear() {
            IntObjectConcurrentMap.this.clear();
        }
